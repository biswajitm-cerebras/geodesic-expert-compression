...
#SBATCH --no-requeue
#SBATCH --output=logs/v27glew_%j.out
#SBATCH --error=logs/v27glew_%j.err
...
echo "========================================================"
echo "  Variant:          ${VARIANT_TAG}  (FISHER_ELEMENTWISE=1)"
...
python src/reap/main.py \
    ...
    --plot_clusters       true \
    2>&1 | tee "logs/v27glew_merge_${SLURM_JOB_ID}.log"
