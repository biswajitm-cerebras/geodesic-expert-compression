...
class WildBenchAnnotator(Annotator):
    ...
    def annotate(self, request_state: RequestState) -> Any:
        ...
        annotator_name = os.environ.get("WILDBENCH_JUDGE_NAME", "gpt")
        annotator_model_name = os.environ.get(
            "WILDBENCH_JUDGE_MODEL_NAME", "openai/gpt-4o-2024-05-13"
        )
        annotator_model_deployment = os.environ.get(
            "WILDBENCH_JUDGE_DEPLOYMENT", "openai/gpt-4o-2024-05-13"
        )
        SHORT_NAME_TO_MODEL_INFO: Dict[str, AnnotatorModelInfo] = {
            annotator_name: AnnotatorModelInfo(
